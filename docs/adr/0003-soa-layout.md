...
All mesh and field data uses SoA throughout the internal model. See `include/mhs/model.hpp` for concrete types. `ModelDefinition` keeps the input-oriented structure; conversion happens once in the preprocessor.
