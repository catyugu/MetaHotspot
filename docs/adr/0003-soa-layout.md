...
All mesh and field data uses SoA throughout the internal model. See `docs/design/model.md` for concrete types. The IO Structure is intentionally AoS to mirror the XML schema; conversion happens once in the preprocessor.
