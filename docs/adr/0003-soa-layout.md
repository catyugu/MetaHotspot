...
All mesh and field data uses SoA throughout the internal model. See `docs/design/internal-model.md` for concrete types. `ModelDefinition` keeps the input-oriented structure; conversion happens once in the preprocessor.
