...
| 目标 | 职责 |
|---|---|
| `mhs_model` | 无第三方依赖的 authoring model 与 `ModelBuilder` |
...
具体布局见 [internal-model.md](docs/design/internal-model.md)，authoring model 见 [io-structure.md](docs/design/io-structure.md)。
